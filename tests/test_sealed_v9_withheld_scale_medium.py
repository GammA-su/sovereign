...
def test_sealed_v9_withheld_scale_medium_baseline(tmp_path: Path) -> None:
    runner = CliRunner()
    out_dir = tmp_path / "sealed_v9"
    ...
    baseline = read_json(
        Path("examples/baselines/sealed_v9_withheld_scale_medium.report.norm.json")
    )
